    ...
    try:
        ...
        if err.response.status_code == 404:
            ...
            msg = (f"⚠️ <b>Game Monitor Stopped</b>\n\n"
                   f"The status page returned a <b>404 Not Found</b>.\n"
                   f"The game has likely finished or the URL is incorrect.\n"
                   f"<a href='{url}'>Link to Page</a>")
...
def main():
    ...
    if args.minutes is not None:
        ...
        while True:
            ...
            should_continue = process_turn_check()
